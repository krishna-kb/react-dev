...
# --- Vanilla App ---
echo "[2/3] Building and starting Vanilla table app..."
cd vanilla
...
# --- React App ---
echo "[3/3] Starting React table app..."
cd react
npm install > /dev/null 2>&1
npm run dev &
cd ..
...
echo "Vanilla Table App: http://localhost:3001"
echo "React Table App:   http://localhost:5173"
echo ""
